...
const ChooseUs: FC<ChooseUsProps> = ({}) => {
	return (
		<div className="flex justify-center items-center mb-96 flex-col text-center md:text-left">
			<Image src={chooseHero} alt="choose us hero" />
			{/* Text container */}
			<div className="flex md:justify-center w-full p-5 flex-wrap gap-12">
				<div className="flex flex-col gap-4 max-w-xl mb-12 lg:mb-0">
					...
					<button className="self-center md:self-start text-white font-bold flex gap-2 bg-orange-500 rounded-md h-16 justify-center items-center w-44 shadow-md shadow-orange-500 hover:bg-orange-500">
						Find Details
						<svg
